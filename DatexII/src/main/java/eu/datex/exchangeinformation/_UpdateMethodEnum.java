...
@XmlType(name = "_UpdateMethodEnum", propOrder = {
    "value"
})
@ToString
@EqualsAndHashCode
public class _UpdateMethodEnum {

    @XmlValue
    protected UpdateMethodEnum value;
     ...
     *     
     */
    public UpdateMethodEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(UpdateMethodEnum value) {
        this.value = value;
    }
