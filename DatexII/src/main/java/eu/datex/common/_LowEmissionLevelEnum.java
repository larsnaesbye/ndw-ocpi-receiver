...
@ToString
@EqualsAndHashCode
public class _LowEmissionLevelEnum {

    @XmlValue
    protected LowEmissionLevelEnum value;
     ...
     *     
     */
    public LowEmissionLevelEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(LowEmissionLevelEnum value) {
        this.value = value;
    }
