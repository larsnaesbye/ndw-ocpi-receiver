...
@ToString
@EqualsAndHashCode
public class _ComparisonOperatorEnum {

    @XmlValue
    protected ComparisonOperatorEnum value;
     ...
     *     
     */
    public ComparisonOperatorEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ComparisonOperatorEnum value) {
        this.value = value;
    }
